package apextechies.theferiwala.allinterfaces;
...
/**
 * Created by shankar on 22/12/17.
 */
...
public class AddressResolverService extends IntentService {
    ...
    private void deliverResultToReceiver(int resultCode, String message, Address address) {
        try {
            ...
            bundle.putDouble(LATITUTE, address.getLatitude());
            bundle.putDouble(LONGITUTE, address.getLongitude());
